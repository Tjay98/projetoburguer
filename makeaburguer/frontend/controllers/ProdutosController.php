    ...
    public function actionPedido(){
        if (yii::$app->user->can('utilizador')){
            ...
            return $this->render('pedido',[
                ...
                'extras'=>$extras,
                'pao' => ArrayHelper::map($pao, 'id', 'nome','preco'),
                'molho' => ArrayHelper::map($molho, 'id', 'nome','preco'),
                'carne' => ArrayHelper::map($carne, 'id', 'nome','preco'),
                'vegetais' => ArrayHelper::map($vegetais, 'id', 'nome','preco'),
                'queijo' => ArrayHelper::map($queijo, 'id', 'nome','preco'),
                'complementosing' => ArrayHelper::map($complementosing, 'id', 'nome','preco'),
                'promocoes' => ArrayHelper::map($promocoes, 'id', 'nome','valor'),
                'model' => $model,
                'model2'=> $model2,
                'model3'=>$model3,
